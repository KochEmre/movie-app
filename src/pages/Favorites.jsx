...
const Favorites = () => {
  ...
  const filteredMovies = favorites
    .filter(movie => 
  ...
  return (
    <div className="wrapper py-6">
      <h1 className="text-3xl font-bold text-white mb-8">Favori Filmlerim</h1>
      ...
      {favorites.length > 0 ? (
        <>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div className="relative w-full md:w-auto">
              ...
              <input
                type="text"
                placeholder="Favori filmlerinizde arayın..."
                value={searchTerm}
          ...
          {filteredMovies.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-300 text-lg">
                "{searchTerm}" ile eşleşen favori film bulunamadı.
              </p>
            </div>
          )}
        </>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-400">
            Film detaylarında kalp simgesine tıklayarak favorilerinize ekleyebilirsiniz.
          </p>
        </div>
      )}
    </div>
